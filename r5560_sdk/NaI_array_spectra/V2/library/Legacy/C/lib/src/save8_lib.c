...
{
return __abstracted_reg_write(4,SCI_REG_CH1_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(0,SCI_REG_CH1_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(1,SCI_REG_CH1_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(2,SCI_REG_CH1_spectrum_CONFIG, handle);
...
{
     int32_t limit = 0;
     int r_rebin = __abstracted_reg_write(rebin, SCI_REG_CH1_spectrum_CONFIG_REBIN, handle);
     limit = (1 << (limit_mode + 29)) + limit_value; 
     int r_limit = __abstracted_reg_write(limit, SCI_REG_CH1_spectrum_CONFIG_LIMIT, handle);
...
{
return __abstracted_reg_read(status, SCI_REG_CH1_spectrum_STATUS, handle);
...
{
return __abstracted_mem_read(val, size, SCI_REG_CH1_spectrum_FIFOADDRESS, timeout, handle, read_data, valid_data);
...
{
return __abstracted_reg_write(4,SCI_REG_CH2_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(0,SCI_REG_CH2_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(1,SCI_REG_CH2_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(2,SCI_REG_CH2_spectrum_CONFIG, handle);
...
{
     int32_t limit = 0;
     int r_rebin = __abstracted_reg_write(rebin, SCI_REG_CH2_spectrum_CONFIG_REBIN, handle);
     limit = (1 << (limit_mode + 29)) + limit_value; 
     int r_limit = __abstracted_reg_write(limit, SCI_REG_CH2_spectrum_CONFIG_LIMIT, handle);
     if (r_rebin == 0 & r_limit == 0)
         return 0;
     else
         return -1;
...
{
return __abstracted_reg_read(status, SCI_REG_CH2_spectrum_STATUS, handle);
...
{
return __abstracted_mem_read(val, size, SCI_REG_CH2_spectrum_FIFOADDRESS, timeout, handle, read_data, valid_data);
...
{
return __abstracted_reg_write(4,SCI_REG_CH3_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(0,SCI_REG_CH3_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(1,SCI_REG_CH3_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(2,SCI_REG_CH3_spectrum_CONFIG, handle);
...
{
     int32_t limit = 0;
     int r_rebin = __abstracted_reg_write(rebin, SCI_REG_CH3_spectrum_CONFIG_REBIN, handle);
     limit = (1 << (limit_mode + 29)) + limit_value; 
     int r_limit = __abstracted_reg_write(limit, SCI_REG_CH3_spectrum_CONFIG_LIMIT, handle);
     if (r_rebin == 0 & r_limit == 0)
         return 0;
     else
         return -1;
...
{
return __abstracted_reg_read(status, SCI_REG_CH3_spectrum_STATUS, handle);
...
{
return __abstracted_mem_read(val, size, SCI_REG_CH3_spectrum_FIFOADDRESS, timeout, handle, read_data, valid_data);
...
{
return __abstracted_reg_write(4,SCI_REG_CH4_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(0,SCI_REG_CH4_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(1,SCI_REG_CH4_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(2,SCI_REG_CH4_spectrum_CONFIG, handle);
...
{
     int32_t limit = 0;
     int r_rebin = __abstracted_reg_write(rebin, SCI_REG_CH4_spectrum_CONFIG_REBIN, handle);
     limit = (1 << (limit_mode + 29)) + limit_value; 
     int r_limit = __abstracted_reg_write(limit, SCI_REG_CH4_spectrum_CONFIG_LIMIT, handle);
     if (r_rebin == 0 & r_limit == 0)
         return 0;
     else
         return -1;
...
{
return __abstracted_reg_read(status, SCI_REG_CH4_spectrum_STATUS, handle);
...
{
return __abstracted_mem_read(val, size, SCI_REG_CH4_spectrum_FIFOADDRESS, timeout, handle, read_data, valid_data);
...
{
return __abstracted_reg_write(4,SCI_REG_CH5_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(0,SCI_REG_CH5_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(1,SCI_REG_CH5_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(2,SCI_REG_CH5_spectrum_CONFIG, handle);
...
{
     int32_t limit = 0;
     int r_rebin = __abstracted_reg_write(rebin, SCI_REG_CH5_spectrum_CONFIG_REBIN, handle);
     limit = (1 << (limit_mode + 29)) + limit_value; 
     int r_limit = __abstracted_reg_write(limit, SCI_REG_CH5_spectrum_CONFIG_LIMIT, handle);
     if (r_rebin == 0 & r_limit == 0)
         return 0;
     else
         return -1;
...
{
return __abstracted_reg_read(status, SCI_REG_CH5_spectrum_STATUS, handle);
...
{
return __abstracted_mem_read(val, size, SCI_REG_CH5_spectrum_FIFOADDRESS, timeout, handle, read_data, valid_data);
...
{
return __abstracted_reg_write(4,SCI_REG_CH6_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(0,SCI_REG_CH6_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(1,SCI_REG_CH6_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(2,SCI_REG_CH6_spectrum_CONFIG, handle);
...
{
     int32_t limit = 0;
     int r_rebin = __abstracted_reg_write(rebin, SCI_REG_CH6_spectrum_CONFIG_REBIN, handle);
     limit = (1 << (limit_mode + 29)) + limit_value; 
     int r_limit = __abstracted_reg_write(limit, SCI_REG_CH6_spectrum_CONFIG_LIMIT, handle);
     if (r_rebin == 0 & r_limit == 0)
         return 0;
     else
         return -1;
...
{
return __abstracted_reg_read(status, SCI_REG_CH6_spectrum_STATUS, handle);
...
{
return __abstracted_mem_read(val, size, SCI_REG_CH6_spectrum_FIFOADDRESS, timeout, handle, read_data, valid_data);
...
{
return __abstracted_reg_write(4,SCI_REG_CH8_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(0,SCI_REG_CH8_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(1,SCI_REG_CH8_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(2,SCI_REG_CH8_spectrum_CONFIG, handle);
...
{
     int32_t limit = 0;
     int r_rebin = __abstracted_reg_write(rebin, SCI_REG_CH8_spectrum_CONFIG_REBIN, handle);
     limit = (1 << (limit_mode + 29)) + limit_value; 
     int r_limit = __abstracted_reg_write(limit, SCI_REG_CH8_spectrum_CONFIG_LIMIT, handle);
     if (r_rebin == 0 & r_limit == 0)
         return 0;
     else
         return -1;
...
{
return __abstracted_reg_read(status, SCI_REG_CH8_spectrum_STATUS, handle);
...
{
return __abstracted_mem_read(val, size, SCI_REG_CH8_spectrum_FIFOADDRESS, timeout, handle, read_data, valid_data);
...
{
return __abstracted_reg_write(4,SCI_REG_Ch13_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(0,SCI_REG_Ch13_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(1,SCI_REG_Ch13_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(2,SCI_REG_Ch13_spectrum_CONFIG, handle);
...
{
     int32_t limit = 0;
     int r_rebin = __abstracted_reg_write(rebin, SCI_REG_Ch13_spectrum_CONFIG_REBIN, handle);
     limit = (1 << (limit_mode + 29)) + limit_value; 
     int r_limit = __abstracted_reg_write(limit, SCI_REG_Ch13_spectrum_CONFIG_LIMIT, handle);
     if (r_rebin == 0 & r_limit == 0)
         return 0;
     else
         return -1;
...
{
return __abstracted_reg_read(status, SCI_REG_Ch13_spectrum_STATUS, handle);
...
{
return __abstracted_mem_read(val, size, SCI_REG_Ch13_spectrum_FIFOADDRESS, timeout, handle, read_data, valid_data);
...
{
return __abstracted_reg_write(4,SCI_REG_CH14_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(0,SCI_REG_CH14_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(1,SCI_REG_CH14_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(2,SCI_REG_CH14_spectrum_CONFIG, handle);
...
{
     int32_t limit = 0;
     int r_rebin = __abstracted_reg_write(rebin, SCI_REG_CH14_spectrum_CONFIG_REBIN, handle);
     limit = (1 << (limit_mode + 29)) + limit_value; 
     int r_limit = __abstracted_reg_write(limit, SCI_REG_CH14_spectrum_CONFIG_LIMIT, handle);
     if (r_rebin == 0 & r_limit == 0)
         return 0;
     else
         return -1;
...
{
return __abstracted_reg_read(status, SCI_REG_CH14_spectrum_STATUS, handle);
...
{
return __abstracted_mem_read(val, size, SCI_REG_CH14_spectrum_FIFOADDRESS, timeout, handle, read_data, valid_data);
...
{
return __abstracted_reg_write(4,SCI_REG_Ch15_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(0,SCI_REG_Ch15_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(1,SCI_REG_Ch15_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(2,SCI_REG_Ch15_spectrum_CONFIG, handle);
...
{
     int32_t limit = 0;
     int r_rebin = __abstracted_reg_write(rebin, SCI_REG_Ch15_spectrum_CONFIG_REBIN, handle);
     limit = (1 << (limit_mode + 29)) + limit_value; 
     int r_limit = __abstracted_reg_write(limit, SCI_REG_Ch15_spectrum_CONFIG_LIMIT, handle);
     if (r_rebin == 0 & r_limit == 0)
         return 0;
     else
         return -1;
...
{
return __abstracted_reg_read(status, SCI_REG_Ch15_spectrum_STATUS, handle);
...
{
return __abstracted_mem_read(val, size, SCI_REG_Ch15_spectrum_FIFOADDRESS, timeout, handle, read_data, valid_data);
...
{
return __abstracted_reg_write(4,SCI_REG_CH16_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(0,SCI_REG_CH16_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(1,SCI_REG_CH16_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(2,SCI_REG_CH16_spectrum_CONFIG, handle);
...
{
     int32_t limit = 0;
     int r_rebin = __abstracted_reg_write(rebin, SCI_REG_CH16_spectrum_CONFIG_REBIN, handle);
     limit = (1 << (limit_mode + 29)) + limit_value; 
     int r_limit = __abstracted_reg_write(limit, SCI_REG_CH16_spectrum_CONFIG_LIMIT, handle);
     if (r_rebin == 0 & r_limit == 0)
         return 0;
     else
         return -1;
...
{
return __abstracted_reg_read(status, SCI_REG_CH16_spectrum_STATUS, handle);
...
{
return __abstracted_mem_read(val, size, SCI_REG_CH16_spectrum_FIFOADDRESS, timeout, handle, read_data, valid_data);
...
{
return __abstracted_reg_write(4,SCI_REG_CH17_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(0,SCI_REG_CH17_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(1,SCI_REG_CH17_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(2,SCI_REG_CH17_spectrum_CONFIG, handle);
...
{
     int32_t limit = 0;
     int r_rebin = __abstracted_reg_write(rebin, SCI_REG_CH17_spectrum_CONFIG_REBIN, handle);
     limit = (1 << (limit_mode + 29)) + limit_value; 
     int r_limit = __abstracted_reg_write(limit, SCI_REG_CH17_spectrum_CONFIG_LIMIT, handle);
     if (r_rebin == 0 & r_limit == 0)
         return 0;
     else
         return -1;
...
{
return __abstracted_reg_read(status, SCI_REG_CH17_spectrum_STATUS, handle);
...
{
return __abstracted_mem_read(val, size, SCI_REG_CH17_spectrum_FIFOADDRESS, timeout, handle, read_data, valid_data);
...
{
return __abstracted_reg_write(4,SCI_REG_CH18_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(0,SCI_REG_CH18_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(1,SCI_REG_CH18_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(2,SCI_REG_CH18_spectrum_CONFIG, handle);
...
{
     int32_t limit = 0;
     int r_rebin = __abstracted_reg_write(rebin, SCI_REG_CH18_spectrum_CONFIG_REBIN, handle);
     limit = (1 << (limit_mode + 29)) + limit_value; 
     int r_limit = __abstracted_reg_write(limit, SCI_REG_CH18_spectrum_CONFIG_LIMIT, handle);
     if (r_rebin == 0 & r_limit == 0)
         return 0;
     else
         return -1;
...
{
return __abstracted_reg_read(status, SCI_REG_CH18_spectrum_STATUS, handle);
...
{
return __abstracted_mem_read(val, size, SCI_REG_CH18_spectrum_FIFOADDRESS, timeout, handle, read_data, valid_data);
...
{
return __abstracted_reg_write(4,SCI_REG_CH19_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(0,SCI_REG_CH19_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(1,SCI_REG_CH19_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(2,SCI_REG_CH19_spectrum_CONFIG, handle);
...
{
     int32_t limit = 0;
     int r_rebin = __abstracted_reg_write(rebin, SCI_REG_CH19_spectrum_CONFIG_REBIN, handle);
     limit = (1 << (limit_mode + 29)) + limit_value; 
     int r_limit = __abstracted_reg_write(limit, SCI_REG_CH19_spectrum_CONFIG_LIMIT, handle);
     if (r_rebin == 0 & r_limit == 0)
         return 0;
     else
         return -1;
...
{
return __abstracted_reg_read(status, SCI_REG_CH19_spectrum_STATUS, handle);
...
{
return __abstracted_mem_read(val, size, SCI_REG_CH19_spectrum_FIFOADDRESS, timeout, handle, read_data, valid_data);
...
{
return __abstracted_reg_write(4,SCI_REG_CH20_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(0,SCI_REG_CH20_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(1,SCI_REG_CH20_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(2,SCI_REG_CH20_spectrum_CONFIG, handle);
...
{
     int32_t limit = 0;
     int r_rebin = __abstracted_reg_write(rebin, SCI_REG_CH20_spectrum_CONFIG_REBIN, handle);
     limit = (1 << (limit_mode + 29)) + limit_value; 
     int r_limit = __abstracted_reg_write(limit, SCI_REG_CH20_spectrum_CONFIG_LIMIT, handle);
     if (r_rebin == 0 & r_limit == 0)
         return 0;
     else
         return -1;
...
{
return __abstracted_reg_read(status, SCI_REG_CH20_spectrum_STATUS, handle);
...
{
return __abstracted_mem_read(val, size, SCI_REG_CH20_spectrum_FIFOADDRESS, timeout, handle, read_data, valid_data);
...
{
return __abstracted_reg_write(4,SCI_REG_CH21_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(0,SCI_REG_CH21_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(1,SCI_REG_CH21_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(2,SCI_REG_CH21_spectrum_CONFIG, handle);
...
{
     int32_t limit = 0;
     int r_rebin = __abstracted_reg_write(rebin, SCI_REG_CH21_spectrum_CONFIG_REBIN, handle);
     limit = (1 << (limit_mode + 29)) + limit_value; 
     int r_limit = __abstracted_reg_write(limit, SCI_REG_CH21_spectrum_CONFIG_LIMIT, handle);
     if (r_rebin == 0 & r_limit == 0)
         return 0;
     else
         return -1;
...
{
return __abstracted_reg_read(status, SCI_REG_CH21_spectrum_STATUS, handle);
...
{
return __abstracted_mem_read(val, size, SCI_REG_CH21_spectrum_FIFOADDRESS, timeout, handle, read_data, valid_data);
...
{
return __abstracted_reg_write(4,SCI_REG_CH22_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(0,SCI_REG_CH22_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(1,SCI_REG_CH22_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(2,SCI_REG_CH22_spectrum_CONFIG, handle);
...
{
     int32_t limit = 0;
     int r_rebin = __abstracted_reg_write(rebin, SCI_REG_CH22_spectrum_CONFIG_REBIN, handle);
     limit = (1 << (limit_mode + 29)) + limit_value; 
     int r_limit = __abstracted_reg_write(limit, SCI_REG_CH22_spectrum_CONFIG_LIMIT, handle);
     if (r_rebin == 0 & r_limit == 0)
         return 0;
     else
         return -1;
...
{
return __abstracted_reg_read(status, SCI_REG_CH22_spectrum_STATUS, handle);
...
{
return __abstracted_mem_read(val, size, SCI_REG_CH22_spectrum_FIFOADDRESS, timeout, handle, read_data, valid_data);
...
{
return __abstracted_reg_write(4,SCI_REG_CH23_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(0,SCI_REG_CH23_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(1,SCI_REG_CH23_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(2,SCI_REG_CH23_spectrum_CONFIG, handle);
...
{
     int32_t limit = 0;
     int r_rebin = __abstracted_reg_write(rebin, SCI_REG_CH23_spectrum_CONFIG_REBIN, handle);
     limit = (1 << (limit_mode + 29)) + limit_value; 
     int r_limit = __abstracted_reg_write(limit, SCI_REG_CH23_spectrum_CONFIG_LIMIT, handle);
     if (r_rebin == 0 & r_limit == 0)
         return 0;
     else
         return -1;
...
{
return __abstracted_reg_read(status, SCI_REG_CH23_spectrum_STATUS, handle);
...
{
return __abstracted_mem_read(val, size, SCI_REG_CH23_spectrum_FIFOADDRESS, timeout, handle, read_data, valid_data);
...
{
return __abstracted_reg_write(4,SCI_REG_CH9_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(0,SCI_REG_CH9_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(1,SCI_REG_CH9_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(2,SCI_REG_CH9_spectrum_CONFIG, handle);
...
{
     int32_t limit = 0;
     int r_rebin = __abstracted_reg_write(rebin, SCI_REG_CH9_spectrum_CONFIG_REBIN, handle);
     limit = (1 << (limit_mode + 29)) + limit_value; 
     int r_limit = __abstracted_reg_write(limit, SCI_REG_CH9_spectrum_CONFIG_LIMIT, handle);
     if (r_rebin == 0 & r_limit == 0)
         return 0;
     else
         return -1;
...
{
return __abstracted_reg_read(status, SCI_REG_CH9_spectrum_STATUS, handle);
...
{
return __abstracted_mem_read(val, size, SCI_REG_CH9_spectrum_FIFOADDRESS, timeout, handle, read_data, valid_data);
...
{
return __abstracted_reg_write(4,SCI_REG_CH10_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(0,SCI_REG_CH10_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(1,SCI_REG_CH10_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(2,SCI_REG_CH10_spectrum_CONFIG, handle);
...
{
     int32_t limit = 0;
     int r_rebin = __abstracted_reg_write(rebin, SCI_REG_CH10_spectrum_CONFIG_REBIN, handle);
     limit = (1 << (limit_mode + 29)) + limit_value; 
     int r_limit = __abstracted_reg_write(limit, SCI_REG_CH10_spectrum_CONFIG_LIMIT, handle);
     if (r_rebin == 0 & r_limit == 0)
         return 0;
     else
         return -1;
...
{
return __abstracted_reg_read(status, SCI_REG_CH10_spectrum_STATUS, handle);
...
{
return __abstracted_mem_read(val, size, SCI_REG_CH10_spectrum_FIFOADDRESS, timeout, handle, read_data, valid_data);
...
{
return __abstracted_reg_write(4,SCI_REG_CH11_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(0,SCI_REG_CH11_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(1,SCI_REG_CH11_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(2,SCI_REG_CH11_spectrum_CONFIG, handle);
...
{
     int32_t limit = 0;
     int r_rebin = __abstracted_reg_write(rebin, SCI_REG_CH11_spectrum_CONFIG_REBIN, handle);
     limit = (1 << (limit_mode + 29)) + limit_value; 
     int r_limit = __abstracted_reg_write(limit, SCI_REG_CH11_spectrum_CONFIG_LIMIT, handle);
     if (r_rebin == 0 & r_limit == 0)
         return 0;
     else
         return -1;
...
{
return __abstracted_reg_read(status, SCI_REG_CH11_spectrum_STATUS, handle);
...
{
return __abstracted_mem_read(val, size, SCI_REG_CH11_spectrum_FIFOADDRESS, timeout, handle, read_data, valid_data);
...
{
return __abstracted_reg_write(4,SCI_REG_CH7_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(0,SCI_REG_CH7_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(1,SCI_REG_CH7_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(2,SCI_REG_CH7_spectrum_CONFIG, handle);
...
{
     int32_t limit = 0;
     int r_rebin = __abstracted_reg_write(rebin, SCI_REG_CH7_spectrum_CONFIG_REBIN, handle);
     limit = (1 << (limit_mode + 29)) + limit_value; 
     int r_limit = __abstracted_reg_write(limit, SCI_REG_CH7_spectrum_CONFIG_LIMIT, handle);
     if (r_rebin == 0 & r_limit == 0)
         return 0;
     else
         return -1;
...
{
return __abstracted_reg_read(status, SCI_REG_CH7_spectrum_STATUS, handle);
...
{
return __abstracted_mem_read(val, size, SCI_REG_CH7_spectrum_FIFOADDRESS, timeout, handle, read_data, valid_data);
...
{
return __abstracted_reg_write(4,SCI_REG_CH12_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(0,SCI_REG_CH12_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(1,SCI_REG_CH12_spectrum_CONFIG, handle);
...
{
return __abstracted_reg_write(2,SCI_REG_CH12_spectrum_CONFIG, handle);
...
{
     int32_t limit = 0;
     int r_rebin = __abstracted_reg_write(rebin, SCI_REG_CH12_spectrum_CONFIG_REBIN, handle);
     limit = (1 << (limit_mode + 29)) + limit_value; 
     int r_limit = __abstracted_reg_write(limit, SCI_REG_CH12_spectrum_CONFIG_LIMIT, handle);
     if (r_rebin == 0 & r_limit == 0)
         return 0;
     else
         return -1;
...
{
return __abstracted_reg_read(status, SCI_REG_CH12_spectrum_STATUS, handle);
...
{
return __abstracted_mem_read(val, size, SCI_REG_CH12_spectrum_FIFOADDRESS, timeout, handle, read_data, valid_data);
