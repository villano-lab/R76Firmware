...
HD_PWD='C:/Users/Owner/Documents/GitHub/R76Firmware/r5560_sdk/NaI_array_spectra/V2/retarget/output/killspectra/killspectra.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_killspectra.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_killspectra.tcl
