...
HD_PWD='C:/Users/Owner/Documents/GitHub/R76Firmware/r5560_sdk/NaI_array_spectra/V2/retarget/output/killspectra/killspectra.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_killspectra.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_killspectra.tcl -notrace
