...
HD_PWD='C:/Users/Owner/Documents/GitHub/R76Firmware/r5560_sdk/NaI_array_spectra/V2/retarget/output/killspectra/killspectra.runs/ZynqDesign_RESET_RX_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZynqDesign_RESET_RX_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZynqDesign_RESET_RX_0.tcl
