; ModuleID = 'C:/GIT/R5560_FRAMEWORK_45/ip_repo/DMATDCZynq/DMATDCZynq/solution1/.autopilot/db/a.g.1.bc'
...
@"guard variable for data_mover(ap_uint<32> volatile*, stream<ap_uint<64> >, int*, int, unsigned long long*, unsigned int*, int*, int*, int*, int*, ap_uint<64>*, bool, ap_uint<32>, unsigned long long*, bool*)inbuffer" = internal unnamed_addr global i8 0 ; [#uses=2 type=i8*]
...
; [#uses=0]
define void @data_mover(%struct.ap_uint.3* %a, %"class.hls::stream.7"* %stream0, i32* %buffer_status, i32 %buffer_ack, i64* %buffer_seq, i32* %bufsize, i32* %debug_buffer_status, i32* %debug_bufsel_0, i32* %debug_buf0_p, i32* %debug_inbuffer_pointer, %struct.ap_uint.0.6* %debug_dst_var, i1 zeroext %run, %struct.ap_uint.3* byval %DDROFFSET, i64* %stat_counter, i1* %interrupt_r) nounwind uwtable {
  call void (...)* @_ssdm_op_SpecTopModule([11 x i8]* @data_mover.str) nounwind
  %tmp.44 = alloca %struct.ap_uint.0.6, align 8   ; [#uses=2 type=%struct.ap_uint.0.6*]
  call void @llvm.dbg.value(metadata !{%struct.ap_uint.3* %a}, i64 0, metadata !4430), !dbg !4431 ; [debug line = 18:37] [debug variable = a]
  call void @llvm.dbg.declare(metadata !{%"class.hls::stream.7"* %stream0}, metadata !4432), !dbg !4433 ; [debug line = 19:23] [debug variable = stream0]
  call void @llvm.dbg.value(metadata !{i32* %buffer_status}, i64 0, metadata !4434), !dbg !4435 ; [debug line = 20:11] [debug variable = buffer_status]
  call void @llvm.dbg.value(metadata !{i32 %buffer_ack}, i64 0, metadata !4436), !dbg !4437 ; [debug line = 21:10] [debug variable = buffer_ack]
  call void @llvm.dbg.value(metadata !{i64* %buffer_seq}, i64 0, metadata !4438), !dbg !4439 ; [debug line = 22:15] [debug variable = buffer_seq]
  call void @llvm.dbg.value(metadata !{i32* %bufsize}, i64 0, metadata !4440), !dbg !4441 ; [debug line = 23:15] [debug variable = bufsize]
  call void @llvm.dbg.value(metadata !{i32* %debug_buffer_status}, i64 0, metadata !4442), !dbg !4443 ; [debug line = 24:11] [debug variable = debug_buffer_status]
  call void @llvm.dbg.value(metadata !{i32* %debug_bufsel_0}, i64 0, metadata !4444), !dbg !4445 ; [debug line = 25:11] [debug variable = debug_bufsel_0]
  call void @llvm.dbg.value(metadata !{i32* %debug_buf0_p}, i64 0, metadata !4446), !dbg !4447 ; [debug line = 26:11] [debug variable = debug_buf0_p]
  call void @llvm.dbg.value(metadata !{i32* %debug_inbuffer_pointer}, i64 0, metadata !4448), !dbg !4449 ; [debug line = 27:11] [debug variable = debug_inbuffer_pointer]
  call void @llvm.dbg.value(metadata !{%struct.ap_uint.0.6* %debug_dst_var}, i64 0, metadata !4450), !dbg !4451 ; [debug line = 28:16] [debug variable = debug_dst_var]
  call void @llvm.dbg.value(metadata !{i1 %run}, i64 0, metadata !4452), !dbg !4453 ; [debug line = 29:11] [debug variable = run]
  call void @llvm.dbg.declare(metadata !{%struct.ap_uint.3* %DDROFFSET}, metadata !4454), !dbg !4455 ; [debug line = 30:18] [debug variable = DDROFFSET]
  call void @llvm.dbg.value(metadata !{i64* %stat_counter}, i64 0, metadata !4456), !dbg !4457 ; [debug line = 31:15] [debug variable = stat_counter]
  call void @llvm.dbg.value(metadata !{i1* %interrupt_r}, i64 0, metadata !4458), !dbg !4459 ; [debug line = 32:12] [debug variable = interrupt_r]
  call void (...)* @_ssdm_SpecArrayDimSize(i64* %buffer_seq, i32 2) nounwind, !dbg !4460 ; [debug line = 35:2]
  call void (...)* @_ssdm_SpecArrayDimSize(i32* %bufsize, i32 2) nounwind, !dbg !4462 ; [debug line = 35:39]
  call void (...)* @_ssdm_SpecArrayDimSize(i64* %stat_counter, i32 4) nounwind, !dbg !4463 ; [debug line = 35:73]
  call void (...)* @_ssdm_op_SpecInterface(i1* %interrupt_r, i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !4464 ; [debug line = 36:1]
  call void (...)* @_ssdm_op_SpecInterface(i64* %stat_counter, i8* getelementptr inbounds ([10 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([5 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !4464 ; [debug line = 36:1]
  call void (...)* @_ssdm_op_SpecInterface(%struct.ap_uint.3* %DDROFFSET, i8* getelementptr inbounds ([10 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([5 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !4464 ; [debug line = 36:1]
  %tmp = zext i1 %run to i32, !dbg !4464          ; [#uses=1 type=i32] [debug line = 36:1]
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32* %debug_inbuffer_pointer, i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !4464 ; [debug line = 36:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %debug_buf0_p, i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !4464 ; [debug line = 36:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %debug_bufsel_0, i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !4464 ; [debug line = 36:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %debug_buffer_status, i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !4464 ; [debug line = 36:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %bufsize, i8* getelementptr inbounds ([10 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([5 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !4464 ; [debug line = 36:1]
  call void (...)* @_ssdm_op_SpecInterface(i64* %buffer_seq, i8* getelementptr inbounds ([10 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([5 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !4464 ; [debug line = 36:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %buffer_ack, i8* getelementptr inbounds ([10 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([5 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !4464 ; [debug line = 36:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %buffer_status, i8* getelementptr inbounds ([10 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([5 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !4464 ; [debug line = 36:1]
  call void (...)* @_ssdm_op_SpecInterface(%"class.hls::stream.7"* %stream0, i8* getelementptr inbounds ([5 x i8]* @.str4, i64 0, i64 0), i32 1, i32 1, i8* getelementptr inbounds ([5 x i8]* @.str5, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !4464 ; [debug line = 36:1]
  call void (...)* @_ssdm_op_SpecInterface(%struct.ap_uint.3* %a, i8* getelementptr inbounds ([6 x i8]* @.str6, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 32, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 16, i32 16, i32 16, i32 16, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !4464 ; [debug line = 36:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, i8* getelementptr inbounds ([13 x i8]* @.str7, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !4464 ; [debug line = 36:1]
  %"guard variable for data_mover(ap_uint<32> volatile*, stream<ap_uint<64> >, int*, int, unsigned long long*, unsigned int*, int*, int*, int*, int*, ap_uint<64>*, bool, ap_uint<32>, unsigned long long*, bool*)inbuffer.load" = load i8* @"guard variable for data_mover(ap_uint<32> volatile*, stream<ap_uint<64> >, int*, int, unsigned long long*, unsigned int*, int*, int*, int*, int*, ap_uint<64>*, bool, ap_uint<32>, unsigned long long*, bool*)inbuffer", align 1, !dbg !4465 ; [#uses=1 type=i8] [debug line = 44:34]
  %tmp.1 = icmp eq i8 %"guard variable for data_mover(ap_uint<32> volatile*, stream<ap_uint<64> >, int*, int, unsigned long long*, unsigned int*, int*, int*, int*, int*, ap_uint<64>*, bool, ap_uint<32>, unsigned long long*, bool*)inbuffer.load", 0, !dbg !4465 ; [#uses=1 type=i1] [debug line = 44:34]
  br i1 %tmp.1, label %.preheader96.preheader, label %._crit_edge, !dbg !4465 ; [debug line = 44:34]

.preheader96.preheader:                           ; preds = %0
  br label %.preheader96, !dbg !4465              ; [debug line = 44:34]
...
.preheader96:                                     ; preds = %.preheader96, %.preheader96.preheader
  ...
  %.rec = add i64 %.07.rec, 1, !dbg !4465         ; [#uses=2 type=i64] [debug line = 44:34]
  %tmp.2 = icmp eq i64 %.rec, 4096, !dbg !4465    ; [#uses=1 type=i1] [debug line = 44:34]
  br i1 %tmp.2, label %1, label %.preheader96, !dbg !4465 ; [debug line = 44:34]

; <label>:1                                       ; preds = %.preheader96
  store i8 1, i8* @"guard variable for data_mover(ap_uint<32> volatile*, stream<ap_uint<64> >, int*, int, unsigned long long*, unsigned int*, int*, int*, int*, int*, ap_uint<64>*, bool, ap_uint<32>, unsigned long long*, bool*)inbuffer", align 1, !dbg !4465 ; [debug line = 44:34]
  br label %._crit_edge, !dbg !4465               ; [debug line = 44:34]

._crit_edge:                                      ; preds = %1, %0
  br i1 %run, label %2, label %21, !dbg !4466     ; [debug line = 57:2]

; <label>:2                                       ; preds = %._crit_edge
  %bufsel.load = load i32* @bufsel, align 4, !dbg !4467 ; [#uses=1 type=i32] [debug line = 60:2]
  %tmp.3 = sext i32 %bufsel.load to i64, !dbg !4467 ; [#uses=1 type=i64] [debug line = 60:2]
  %bufstatus.addr = getelementptr inbounds [2 x i1]* @bufstatus, i64 0, i64 %tmp.3, !dbg !4467 ; [#uses=1 type=i1*] [debug line = 60:2]
  %bufstatus.load = load i1* %bufstatus.addr, align 1, !dbg !4467 ; [#uses=2 type=i1] [debug line = 60:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %bufstatus.load) nounwind
  br i1 %bufstatus.load, label %.critedge, label %3, !dbg !4467 ; [debug line = 60:2]

; <label>:3                                       ; preds = %2
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.7"* %stream0}, i64 0, metadata !4469), !dbg !4471 ; [debug line = 112:48@63:8] [debug variable = this]
  %stream0.addr = getelementptr inbounds %"class.hls::stream.7"* %stream0, i64 0, i32 0, !dbg !4474 ; [#uses=2 type=%struct.ap_uint.0.6*] [debug line = 113:20@63:8]
  %tmp.5 = call i1 @"_ssdm_op_IfCanRead.Stream.%struct.ap_uint.0.6 = type { %struct.ap_int_base.1.5 }P"(%struct.ap_uint.0.6* %stream0.addr) nounwind, !dbg !4474 ; [#uses=1 type=i1] [debug line = 113:20@63:8]
  call void @llvm.dbg.value(metadata !{i1 %tmp.5}, i64 0, metadata !4476), !dbg !4474 ; [debug line = 113:20@63:8] [debug variable = tmp]
  br i1 %tmp.5, label %4, label %.critedge93, !dbg !4472 ; [debug line = 63:8]

; <label>:4                                       ; preds = %3
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.7"* %stream0}, i64 0, metadata !4477), !dbg !4479 ; [debug line = 123:48@65:4] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{%struct.ap_uint.0.6* %tmp.44}, metadata !4482) nounwind, !dbg !4484 ; [debug line = 124:22@65:4] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{%struct.ap_uint.0.6* %tmp.44}, i64 0, metadata !4485), !dbg !4487 ; [debug line = 186:41@124:25@65:4] [debug variable = this]
  call void @llvm.dbg.value(metadata !{%struct.ap_uint.0.6* %tmp.44}, i64 0, metadata !4489), !dbg !4490 ; [debug line = 186:41@186:60@124:25@65:4] [debug variable = this]
  call void @"_ssdm_op_IfRead.Stream.%struct.ap_uint.0.6 = type { %struct.ap_int_base.1.5 }P.%struct.ap_uint.0.6 = type { %struct.ap_int_base.1.5 }P"(%struct.ap_uint.0.6* %stream0.addr, %struct.ap_uint.0.6* %tmp.44) nounwind, !dbg !4492 ; [debug line = 125:9@65:4]
  call void @llvm.dbg.value(metadata !{%struct.ap_uint.0.6* %tmp.44}, i64 0, metadata !4493), !dbg !4494 ; [debug line = 280:84@126:9@65:4] [debug variable = op2]
  %op2.assign.addr = getelementptr inbounds %struct.ap_uint.0.6* %tmp.44, i64 0, i32 0, i32 0, i32 0, !dbg !4496 ; [#uses=1 type=i64*] [debug line = 281:5@126:9@65:4]
  %dst_var.V = load i64* %op2.assign.addr, align 8, !dbg !4496 ; [#uses=4 type=i64] [debug line = 281:5@126:9@65:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i64 %dst_var.V) nounwind
  call void @llvm.dbg.value(metadata !{i64 %dst_var.V}, i64 0, metadata !4498), !dbg !4496 ; [debug line = 281:5@126:9@65:4] [debug variable = dst_var.V]
  %inbuffer_pointer.load = load i32* @inbuffer_pointer, align 4, !dbg !4506 ; [#uses=3 type=i32] [debug line = 66:4]
  %tmp.7 = add nsw i32 %inbuffer_pointer.load, 1, !dbg !4506 ; [#uses=1 type=i32] [debug line = 66:4]
  %tmp.8 = sext i32 %inbuffer_pointer.load to i64, !dbg !4506 ; [#uses=1 type=i64] [debug line = 66:4]
  call void @llvm.dbg.value(metadata !{i64 %dst_var.V}, i64 0, metadata !4507), !dbg !4510 ; [debug line = 941:79@1538:15@200:100@200:101@66:35] [debug variable = __Val2__]
  %__Result__ = call i64 @llvm.part.select.i64(i64 %dst_var.V, i32 0, i32 31) nounwind, !dbg !4516 ; [#uses=1 type=i64] [debug line = 941:81@1538:15@200:100@200:101@66:35]
  call void @llvm.dbg.value(metadata !{i64 %__Result__}, i64 0, metadata !4517), !dbg !4516 ; [debug line = 941:81@1538:15@200:100@200:101@66:35] [debug variable = __Result__]
  call void @llvm.dbg.value(metadata !{i64 %__Result__}, i64 0, metadata !4518), !dbg !4520 ; [debug line = 941:180@1538:15@200:100@200:101@66:35] [debug variable = ret.V]
  %.045 = trunc i64 %__Result__ to i32, !dbg !4511 ; [#uses=1 type=i32] [debug line = 1538:15@200:100@200:101@66:35]
  %inbuffer.addr = getelementptr inbounds [4096 x %struct.ap_uint.3]* @inbuffer, i64 0, i64 %tmp.8, i32 0, i32 0, i32 0, !dbg !4521 ; [#uses=1 type=i32*] [debug line = 281:5@66:35]
  store i32 %.045, i32* %inbuffer.addr, align 4, !dbg !4521 ; [debug line = 281:5@66:35]
  %tmp.9 = add nsw i32 %inbuffer_pointer.load, 2, !dbg !4523 ; [#uses=2 type=i32] [debug line = 67:4]
  store i32 %tmp.9, i32* @inbuffer_pointer, align 4, !dbg !4523 ; [debug line = 67:4]
  %tmp.10 = sext i32 %tmp.7 to i64, !dbg !4523    ; [#uses=1 type=i64] [debug line = 67:4]
  call void @llvm.dbg.value(metadata !{i64 %dst_var.V}, i64 0, metadata !4507), !dbg !4524 ; [debug line = 941:79@1538:15@200:100@200:101@67:35] [debug variable = __Val2__]
  %__Result__.1 = call i64 @llvm.part.select.i64(i64 %dst_var.V, i32 32, i32 63) nounwind, !dbg !4529 ; [#uses=1 type=i64] [debug line = 941:81@1538:15@200:100@200:101@67:35]
  call void @llvm.dbg.value(metadata !{i64 %__Result__.1}, i64 0, metadata !4517), !dbg !4529 ; [debug line = 941:81@1538:15@200:100@200:101@67:35] [debug variable = __Result__]
  call void @llvm.dbg.value(metadata !{i64 %__Result__.1}, i64 0, metadata !4518), !dbg !4530 ; [debug line = 941:180@1538:15@200:100@200:101@67:35] [debug variable = ret.V]
  %.027 = trunc i64 %__Result__.1 to i32, !dbg !4525 ; [#uses=1 type=i32] [debug line = 1538:15@200:100@200:101@67:35]
  %inbuffer.addr.1 = getelementptr inbounds [4096 x %struct.ap_uint.3]* @inbuffer, i64 0, i64 %tmp.10, i32 0, i32 0, i32 0, !dbg !4531 ; [#uses=1 type=i32*] [debug line = 281:5@67:35]
  store i32 %.027, i32* %inbuffer.addr.1, align 4, !dbg !4531 ; [debug line = 281:5@67:35]
  store i32 %tmp.9, i32* %debug_inbuffer_pointer, align 4, !dbg !4532 ; [debug line = 72:5]
  %inbuffer_pointer.load.1 = load i32* @inbuffer_pointer, align 4, !dbg !4533 ; [#uses=1 type=i32] [debug line = 75:5]
  %tmp.11 = icmp eq i32 %inbuffer_pointer.load.1, 4096, !dbg !4533 ; [#uses=1 type=i1] [debug line = 75:5]
  %out_counter.load = load i64* @out_counter, align 8, !dbg !4534 ; [#uses=1 type=i64] [debug line = 80:5]
  %tmp.12 = add i64 %out_counter.load, 1, !dbg !4534 ; [#uses=1 type=i64] [debug line = 80:5]
  store i64 %tmp.12, i64* @out_counter, align 8, !dbg !4534 ; [debug line = 80:5]
  call void @llvm.dbg.value(metadata !{%struct.ap_uint.0.6* %debug_dst_var}, i64 0, metadata !4535), !dbg !4536 ; [debug line = 280:50@84:3] [debug variable = this]
  %debug_dst_var.addr = getelementptr inbounds %struct.ap_uint.0.6* %debug_dst_var, i64 0, i32 0, i32 0, i32 0, !dbg !4538 ; [#uses=1 type=i64*] [debug line = 281:5@84:3]
  store i64 %dst_var.V, i64* %debug_dst_var.addr, align 8, !dbg !4538 ; [debug line = 281:5@84:3]
  br i1 %tmp.11, label %._crit_edge101, label %.critedge93, !dbg !4539 ; [debug line = 97:2]

.critedge:                                        ; preds = %2
  %lost_counter.load = load i64* @lost_counter, align 8, !dbg !4540 ; [#uses=1 type=i64] [debug line = 93:5]
  %tmp.4 = add i64 %lost_counter.load, 1, !dbg !4540 ; [#uses=1 type=i64] [debug line = 93:5]
  store i64 %tmp.4, i64* @lost_counter, align 8, !dbg !4540 ; [debug line = 93:5]
  br label %.critedge93

.critedge93:                                      ; preds = %.critedge, %4, %3
  %swap_timeout.load = load i1* @swap_timeout, align 1, !dbg !4539 ; [#uses=1 type=i1] [debug line = 97:2]
  br i1 %swap_timeout.load, label %._crit_edge101, label %.critedge93._crit_edge103, !dbg !4539 ; [debug line = 97:2]

._crit_edge101:                                   ; preds = %.critedge93, %4
  %bufsel.load.1 = load i32* @bufsel, align 4, !dbg !4539 ; [#uses=2 type=i32] [debug line = 97:2]
  %tmp.15 = sext i32 %bufsel.load.1 to i64, !dbg !4539 ; [#uses=2 type=i64] [debug line = 97:2]
  %bufstatus.addr.2 = getelementptr inbounds [2 x i1]* @bufstatus, i64 0, i64 %tmp.15, !dbg !4539 ; [#uses=2 type=i1*] [debug line = 97:2]
  %bufstatus.load.1 = load i1* %bufstatus.addr.2, align 1, !dbg !4539 ; [#uses=2 type=i1] [debug line = 97:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %bufstatus.load.1) nounwind
  br i1 %bufstatus.load.1, label %.critedge93._crit_edge103, label %5, !dbg !4539 ; [debug line = 97:2]

; <label>:5                                       ; preds = %._crit_edge101
  %DDROFFSET.addr = getelementptr inbounds %struct.ap_uint.3* %DDROFFSET, i64 0, i32 0, i32 0, i32 0, !dbg !4542 ; [#uses=1 type=i32*] [debug line = 3426:0@3523:0@100:9]
  %DDROFFSET.load = load i32* %DDROFFSET.addr, align 4, !dbg !4542 ; [#uses=2 type=i32] [debug line = 3426:0@3523:0@100:9]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %DDROFFSET.load) nounwind
  %tmp.16 = lshr i32 %DDROFFSET.load, 2, !dbg !4542 ; [#uses=1 type=i32] [debug line = 3426:0@3523:0@100:9]
  call void @llvm.dbg.value(metadata !{%struct.ap_uint.3* %a}, i64 0, metadata !4548), !dbg !4549 ; [debug line = 3458:122@100:9] [debug variable = i_op]
  %op2 = zext i32 %tmp.16 to i64, !dbg !4550      ; [#uses=1 type=i64] [debug line = 1710:68@3458:215@100:9]
  call void @llvm.dbg.value(metadata !{i64 %op2}, i64 0, metadata !4554), !dbg !4552 ; [debug line = 3458:215@100:9] [debug variable = op2]
  %buf_p.load = load i32* @buf_p, align 4, !dbg !4546 ; [#uses=2 type=i32] [debug line = 100:9]
  %tmp.17 = sext i32 %buf_p.load to i64, !dbg !4546 ; [#uses=1 type=i64] [debug line = 100:9]
  %tmp.18 = shl nsw i32 %bufsel.load.1, 22, !dbg !4546 ; [#uses=1 type=i32] [debug line = 100:9]
  %tmp.19 = sext i32 %tmp.18 to i64, !dbg !4546   ; [#uses=1 type=i64] [debug line = 100:9]
  %.sum = add i64 %op2, %tmp.19, !dbg !4546       ; [#uses=1 type=i64] [debug line = 100:9]
  %.sum1 = add i64 %.sum, %tmp.17, !dbg !4546     ; [#uses=1 type=i64] [debug line = 100:9]
  %a.addr = getelementptr inbounds %struct.ap_uint.3* %a, i64 %.sum1, !dbg !4546 ; [#uses=1 type=%struct.ap_uint.3*] [debug line = 100:9]
  call void @"memcpy.%struct.ap_uint.3 = type { %struct.ap_int_base.2 }P.%struct.ap_uint.3 = type { %struct.ap_int_base.2 }P"(%struct.ap_uint.3* %a.addr, %struct.ap_uint.3* getelementptr inbounds ([4096 x %struct.ap_uint.3]* @inbuffer, i64 0, i64 0), i64 16384, i32 4, i1 false) nounwind, !dbg !4546 ; [debug line = 100:9]
  %inbuffer_pointer.load.2 = load i32* @inbuffer_pointer, align 4, !dbg !4555 ; [#uses=1 type=i32] [debug line = 108:3]
  %tmp.20 = add nsw i32 %inbuffer_pointer.load.2, %buf_p.load, !dbg !4555 ; [#uses=3 type=i32] [debug line = 108:3]
  store i32 %tmp.20, i32* @buf_p, align 4, !dbg !4555 ; [debug line = 108:3]
  store i32 0, i32* @inbuffer_pointer, align 4, !dbg !4556 ; [debug line = 109:3]
  %tmp.21 = icmp eq i32 %tmp.20, 4194304, !dbg !4557 ; [#uses=1 type=i1] [debug line = 112:4]
  br i1 %tmp.21, label %._crit_edge105, label %6, !dbg !4557 ; [debug line = 112:4]

; <label>:6                                       ; preds = %5
  %swap_timeout.load.1 = load i1* @swap_timeout, align 1, !dbg !4557 ; [#uses=1 type=i1] [debug line = 112:4]
  br i1 %swap_timeout.load.1, label %._crit_edge105, label %._crit_edge107, !dbg !4557 ; [debug line = 112:4]

._crit_edge105:                                   ; preds = %6, %5
  store i1 true, i1* %bufstatus.addr.2, align 1, !dbg !4558 ; [debug line = 114:5]
  %bufsize.addr.1 = getelementptr inbounds i32* %bufsize, i64 %tmp.15, !dbg !4560 ; [#uses=1 type=i32*] [debug line = 115:5]
  store i32 %tmp.20, i32* %bufsize.addr.1, align 4, !dbg !4560 ; [debug line = 115:5]
  store i32 0, i32* @buftimeout, align 4, !dbg !4561 ; [debug line = 116:5]
  store i1 false, i1* @swap_timeout, align 1, !dbg !4562 ; [debug line = 117:5]
  store i32 0, i32* @buf_p, align 4, !dbg !4563   ; [debug line = 118:5]
  %bufsel.load.2 = load i32* @bufsel, align 4, !dbg !4564 ; [#uses=3 type=i32] [debug line = 119:5]
  %tmp.22 = icmp eq i32 %bufsel.load.2, 0, !dbg !4564 ; [#uses=1 type=i1] [debug line = 119:5]
  br i1 %tmp.22, label %7, label %8, !dbg !4564   ; [debug line = 119:5]

; <label>:7                                       ; preds = %._crit_edge105
  store i32 1, i32* @bufsel, align 4, !dbg !4565  ; [debug line = 120:6]
  br label %._crit_edge108, !dbg !4565            ; [debug line = 120:6]

; <label>:8                                       ; preds = %._crit_edge105
  %tmp.23 = icmp eq i32 %bufsel.load.2, 1, !dbg !4566 ; [#uses=1 type=i1] [debug line = 121:10]
  br i1 %tmp.23, label %9, label %._crit_edge108, !dbg !4566 ; [debug line = 121:10]

; <label>:9                                       ; preds = %8
  store i32 0, i32* @bufsel, align 4, !dbg !4567  ; [debug line = 122:6]
  br label %._crit_edge108, !dbg !4567            ; [debug line = 122:6]

._crit_edge108:                                   ; preds = %9, %8, %7
  %tmp.24 = phi i32 [ 1, %7 ], [ 0, %9 ], [ %bufsel.load.2, %8 ] ; [#uses=1 type=i32]
  %bsc.load = load i64* @bsc, align 8, !dbg !4568 ; [#uses=1 type=i64] [debug line = 124:5]
  %tmp.25 = add i64 %bsc.load, 1, !dbg !4568      ; [#uses=2 type=i64] [debug line = 124:5]
  store i64 %tmp.25, i64* @bsc, align 8, !dbg !4568 ; [debug line = 124:5]
  %tmp.26 = sext i32 %tmp.24 to i64, !dbg !4569   ; [#uses=1 type=i64] [debug line = 125:5]
  %bsq.addr = getelementptr inbounds [2 x i64]* @bsq, i64 0, i64 %tmp.26, !dbg !4569 ; [#uses=1 type=i64*] [debug line = 125:5]
  store i64 %tmp.25, i64* %bsq.addr, align 8, !dbg !4569 ; [debug line = 125:5]
  br label %10, !dbg !4570                        ; [debug line = 126:18]

; <label>:10                                      ; preds = %11, %._crit_edge108
  %i1 = phi i32 [ 0, %._crit_edge108 ], [ %i.3, %11 ] ; [#uses=3 type=i32]
  %exitcond1 = icmp eq i32 %i1, 2, !dbg !4570     ; [#uses=1 type=i1] [debug line = 126:18]
  br i1 %exitcond1, label %12, label %11, !dbg !4570 ; [debug line = 126:18]

; <label>:11                                      ; preds = %10
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([8 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !4572 ; [debug line = 127:6]
  %rbegin2 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([8 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !4572 ; [#uses=1 type=i32] [debug line = 127:6]
  call void (...)* @_ssdm_Unroll(i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !4574 ; [debug line = 128:1]
  %tmp.27 = sext i32 %i1 to i64, !dbg !4575       ; [#uses=2 type=i64] [debug line = 128:6]
  %bsq.addr.1 = getelementptr inbounds [2 x i64]* @bsq, i64 0, i64 %tmp.27, !dbg !4575 ; [#uses=1 type=i64*] [debug line = 128:6]
  %bsq.load = load i64* %bsq.addr.1, align 8, !dbg !4575 ; [#uses=2 type=i64] [debug line = 128:6]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i64 %bsq.load) nounwind
  %buffer_seq.addr.1 = getelementptr inbounds i64* %buffer_seq, i64 %tmp.27, !dbg !4575 ; [#uses=1 type=i64*] [debug line = 128:6]
  store i64 %bsq.load, i64* %buffer_seq.addr.1, align 8, !dbg !4575 ; [debug line = 128:6]
  %rend112 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([8 x i8]* @.str8, i64 0, i64 0), i32 %rbegin2) nounwind, !dbg !4576 ; [#uses=0 type=i32] [debug line = 129:5]
  %i.3 = add nsw i32 %i1, 1, !dbg !4577           ; [#uses=1 type=i32] [debug line = 126:26]
  call void @llvm.dbg.value(metadata !{i32 %i.3}, i64 0, metadata !4578), !dbg !4577 ; [debug line = 126:26] [debug variable = i]
  br label %10, !dbg !4577                        ; [debug line = 126:26]

; <label>:12                                      ; preds = %10
  store i1 true, i1* %interrupt_r, align 1, !dbg !4579 ; [debug line = 131:5]
  br label %._crit_edge107, !dbg !4580            ; [debug line = 132:4]

._crit_edge107:                                   ; preds = %12, %6
  br label %.critedge93._crit_edge103, !dbg !4581 ; [debug line = 133:2]

.critedge93._crit_edge103:                        ; preds = %._crit_edge107, %._crit_edge101, %.critedge93
  %bufstatus.load.2 = load i1* getelementptr inbounds ([2 x i1]* @bufstatus, i64 0, i64 0), align 1, !dbg !4582 ; [#uses=2 type=i1] [debug line = 136:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %bufstatus.load.2) nounwind
  %tmp.29 = zext i1 %bufstatus.load.2 to i32, !dbg !4582 ; [#uses=1 type=i32] [debug line = 136:2]
  %bufstatus.load.3 = load i1* getelementptr inbounds ([2 x i1]* @bufstatus, i64 0, i64 1), align 1, !dbg !4582 ; [#uses=2 type=i1] [debug line = 136:2]
  ...
  store i32 %tmp.30, i32* %buffer_status, align 4, !dbg !4582 ; [debug line = 136:2]
  br label %13, !dbg !4583                        ; [debug line = 140:23]
...
; <label>:13                                      ; preds = %._crit_edge109, %.critedge93._crit_edge103
  ...
  %exitcond2 = icmp eq i32 %i.1, 2, !dbg !4583    ; [#uses=1 type=i1] [debug line = 140:23]
  br i1 %exitcond2, label %17, label %14, !dbg !4583 ; [debug line = 140:23]

; <label>:14                                      ; preds = %13
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([16 x i8]* @.str9, i64 0, i64 0)) nounwind, !dbg !4585 ; [debug line = 141:3]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([16 x i8]* @.str9, i64 0, i64 0)) nounwind, !dbg !4585 ; [#uses=1 type=i32] [debug line = 141:3]
  call void (...)* @_ssdm_Unroll(i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !4587 ; [debug line = 142:1]
  %obuffer_ack.load = load i32* @obuffer_ack, align 4, !dbg !4588 ; [#uses=1 type=i32] [debug line = 142:3]
  %tmp.35 = ashr i32 %obuffer_ack.load, %i.1, !dbg !4588 ; [#uses=1 type=i32] [debug line = 142:3]
  %tmp.36 = and i32 %tmp.35, 1, !dbg !4588        ; [#uses=1 type=i32] [debug line = 142:3]
  %tmp.37 = icmp eq i32 %tmp.36, 0, !dbg !4588    ; [#uses=1 type=i1] [debug line = 142:3]
  br i1 %tmp.37, label %15, label %._crit_edge109, !dbg !4588 ; [debug line = 142:3]

; <label>:15                                      ; preds = %14
  %tmp.39 = ashr i32 %buffer_ack, %i.1, !dbg !4588 ; [#uses=1 type=i32] [debug line = 142:3]
  %tmp.40 = and i32 %tmp.39, 1, !dbg !4588        ; [#uses=1 type=i32] [debug line = 142:3]
  %tmp.41 = icmp eq i32 %tmp.40, 0, !dbg !4588    ; [#uses=1 type=i1] [debug line = 142:3]
  br i1 %tmp.41, label %._crit_edge109, label %16, !dbg !4588 ; [debug line = 142:3]

; <label>:16                                      ; preds = %15
  %tmp.42 = sext i32 %i.1 to i64, !dbg !4589      ; [#uses=1 type=i64] [debug line = 144:4]
  %bufstatus.addr.3 = getelementptr inbounds [2 x i1]* @bufstatus, i64 0, i64 %tmp.42, !dbg !4589 ; [#uses=1 type=i1*] [debug line = 144:4]
  store i1 false, i1* %bufstatus.addr.3, align 1, !dbg !4589 ; [debug line = 144:4]
  br label %._crit_edge109, !dbg !4591            ; [debug line = 145:3]

._crit_edge109:                                   ; preds = %16, %15, %14
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([16 x i8]* @.str9, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !4592 ; [#uses=0 type=i32] [debug line = 147:2]
  %i.4 = add nsw i32 %i.1, 1, !dbg !4593          ; [#uses=1 type=i32] [debug line = 140:31]
  call void @llvm.dbg.value(metadata !{i32 %i.4}, i64 0, metadata !4578), !dbg !4593 ; [debug line = 140:31] [debug variable = i]
  br label %13, !dbg !4593                        ; [debug line = 140:31]

; <label>:17                                      ; preds = %13
  store i32 %buffer_ack, i32* @obuffer_ack, align 4, !dbg !4594 ; [debug line = 148:2]
  %bufsel.load.3 = load i32* @bufsel, align 4, !dbg !4595 ; [#uses=1 type=i32] [debug line = 150:2]
  store i32 %bufsel.load.3, i32* %debug_bufsel_0, align 4, !dbg !4595 ; [debug line = 150:2]
  %buf_p.load.1 = load i32* @buf_p, align 4, !dbg !4596 ; [#uses=1 type=i32] [debug line = 151:2]
  store i32 %buf_p.load.1, i32* %debug_buf0_p, align 4, !dbg !4596 ; [debug line = 151:2]
  %bufstatus.load.4 = load i1* getelementptr inbounds ([2 x i1]* @bufstatus, i64 0, i64 0), align 1, !dbg !4597 ; [#uses=2 type=i1] [debug line = 153:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %bufstatus.load.4) nounwind
  %tmp.31 = zext i1 %bufstatus.load.4 to i32, !dbg !4597 ; [#uses=1 type=i32] [debug line = 153:2]
  %bufstatus.load.5 = load i1* getelementptr inbounds ([2 x i1]* @bufstatus, i64 0, i64 1), align 1, !dbg !4597 ; [#uses=2 type=i1] [debug line = 153:2]
  ...
  store i32 %tmp.32, i32* %debug_buffer_status, align 4, !dbg !4597 ; [debug line = 153:2]
  store i64 0, i64* %stat_counter, align 8, !dbg !4598 ; [debug line = 158:2]
  %out_counter.load.1 = load i64* @out_counter, align 8, !dbg !4599 ; [#uses=1 type=i64] [debug line = 159:2]
  %stat_counter.addr = getelementptr inbounds i64* %stat_counter, i64 1, !dbg !4599 ; [#uses=1 type=i64*] [debug line = 159:2]
  store i64 %out_counter.load.1, i64* %stat_counter.addr, align 8, !dbg !4599 ; [debug line = 159:2]
  %lost_counter.load.1 = load i64* @lost_counter, align 8, !dbg !4600 ; [#uses=1 type=i64] [debug line = 160:2]
  %stat_counter.addr.1 = getelementptr inbounds i64* %stat_counter, i64 2, !dbg !4600 ; [#uses=1 type=i64*] [debug line = 160:2]
  store i64 %lost_counter.load.1, i64* %stat_counter.addr.1, align 8, !dbg !4600 ; [debug line = 160:2]
  %buftimeout.load = load i32* @buftimeout, align 4, !dbg !4601 ; [#uses=3 type=i32] [debug line = 161:2]
  %tmp.33 = zext i32 %buftimeout.load to i64, !dbg !4601 ; [#uses=1 type=i64] [debug line = 161:2]
  %stat_counter.addr.2 = getelementptr inbounds i64* %stat_counter, i64 4, !dbg !4601 ; [#uses=1 type=i64*] [debug line = 161:2]
  store i64 %tmp.33, i64* %stat_counter.addr.2, align 8, !dbg !4601 ; [debug line = 161:2]
  %tmp.34 = icmp eq i32 %buftimeout.load, 10000000, !dbg !4602 ; [#uses=1 type=i1] [debug line = 168:2]
  br i1 %tmp.34, label %18, label %19, !dbg !4602 ; [debug line = 168:2]

; <label>:18                                      ; preds = %17
  store i1 true, i1* @swap_timeout, align 1, !dbg !4603 ; [debug line = 170:3]
  br label %20, !dbg !4605                        ; [debug line = 172:2]

; <label>:19                                      ; preds = %17
  %tmp.38 = add i32 %buftimeout.load, 1, !dbg !4606 ; [#uses=1 type=i32] [debug line = 174:3]
  br label %20

; <label>:20                                      ; preds = %19, %18
  %storemerge = phi i32 [ %tmp.38, %19 ], [ 0, %18 ] ; [#uses=1 type=i32]
  store i32 %storemerge, i32* @buftimeout, align 4, !dbg !4607 ; [debug line = 171:3]
  br label %25, !dbg !4608                        ; [debug line = 179:2]

; <label>:21                                      ; preds = %._crit_edge
  store i32 0, i32* @bufsel, align 4, !dbg !4609  ; [debug line = 182:3]
  store i32 0, i32* @inbuffer_pointer, align 4, !dbg !4611 ; [debug line = 183:3]
  store i32 0, i32* @buftimeout, align 4, !dbg !4612 ; [debug line = 184:3]
  store i32 0, i32* @obuffer_ack, align 4, !dbg !4613 ; [debug line = 185:3]
  store i32 0, i32* %buffer_status, align 4, !dbg !4614 ; [debug line = 186:3]
  store i64 0, i64* @bsc, align 8, !dbg !4615     ; [debug line = 187:3]
  store i64 0, i64* @out_counter, align 8, !dbg !4616 ; [debug line = 189:3]
  store i64 0, i64* @lost_counter, align 8, !dbg !4617 ; [debug line = 190:3]
  br label %22, !dbg !4618                        ; [debug line = 191:17]

; <label>:22                                      ; preds = %23, %21
  %i.2 = phi i32 [ 0, %21 ], [ %i, %23 ]          ; [#uses=3 type=i32]
  %exitcond = icmp eq i32 %i.2, 2, !dbg !4618     ; [#uses=1 type=i1] [debug line = 191:17]
  br i1 %exitcond, label %24, label %23, !dbg !4618 ; [debug line = 191:17]

; <label>:23                                      ; preds = %22
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([9 x i8]* @.str10, i64 0, i64 0)) nounwind, !dbg !4620 ; [debug line = 192:4]
  %rbegin1 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([9 x i8]* @.str10, i64 0, i64 0)) nounwind, !dbg !4620 ; [#uses=1 type=i32] [debug line = 192:4]
  call void (...)* @_ssdm_Unroll(i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !4622 ; [debug line = 193:1]
  %tmp.13 = sext i32 %i.2 to i64, !dbg !4623      ; [#uses=3 type=i64] [debug line = 193:3]
  %buffer_seq.addr = getelementptr inbounds i64* %buffer_seq, i64 %tmp.13, !dbg !4623 ; [#uses=1 type=i64*] [debug line = 193:3]
  store i64 0, i64* %buffer_seq.addr, align 8, !dbg !4623 ; [debug line = 193:3]
  %bufsize.addr = getelementptr inbounds i32* %bufsize, i64 %tmp.13, !dbg !4624 ; [#uses=1 type=i32*] [debug line = 194:3]
  store i32 0, i32* %bufsize.addr, align 4, !dbg !4624 ; [debug line = 194:3]
  %bufstatus.addr.1 = getelementptr inbounds [2 x i1]* @bufstatus, i64 0, i64 %tmp.13, !dbg !4625 ; [#uses=1 type=i1*] [debug line = 195:3]
  store i1 false, i1* %bufstatus.addr.1, align 1, !dbg !4625 ; [debug line = 195:3]
  %rend114 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([9 x i8]* @.str10, i64 0, i64 0), i32 %rbegin1) nounwind, !dbg !4626 ; [#uses=0 type=i32] [debug line = 196:2]
  %i = add nsw i32 %i.2, 1, !dbg !4627            ; [#uses=1 type=i32] [debug line = 191:25]
  call void @llvm.dbg.value(metadata !{i32 %i}, i64 0, metadata !4578), !dbg !4627 ; [debug line = 191:25] [debug variable = i]
  br label %22, !dbg !4627                        ; [debug line = 191:25]

; <label>:24                                      ; preds = %22
  store i1 false, i1* %interrupt_r, align 1, !dbg !4628 ; [debug line = 198:3]
  br label %25

; <label>:25                                      ; preds = %24, %20
  ret void, !dbg !4629                            ; [debug line = 200:1]
}
...
!llvm.dbg.cu = !{!0}
!opencl.kernels = !{!4377, !4384, !4390, !4396, !4401, !4401, !4390, !4407, !4390, !4390, !4390, !4410, !4413, !4413, !4413, !4390, !4390, !4390, !4390, !4390, !4416, !4418, !4421, !4421, !4427, !4390, !4390, !4390, !4390, !4390, !4390}
!hls.encrypted.func = !{}
...
!2623 = metadata !{i32 786484, i32 0, metadata !876, metadata !"bufstatus", metadata !"bufstatus", metadata !"", metadata !877, i32 36, metadata !2624, i32 1, i32 1, [2 x i1]* @bufstatus} ; [ DW_TAG_variable ]
...
!2627 = metadata !{i32 786484, i32 0, metadata !876, metadata !"bsq", metadata !"bsq", metadata !"", metadata !877, i32 37, metadata !2628, i32 1, i32 1, [2 x i64]* @bsq} ; [ DW_TAG_variable ]
...
!2629 = metadata !{i32 786484, i32 0, metadata !876, metadata !"lost_counter", metadata !"lost_counter", metadata !"", metadata !877, i32 38, metadata !2257, i32 1, i32 1, i64* @lost_counter} ; [ DW_TAG_variable ]
!2630 = metadata !{i32 786484, i32 0, metadata !876, metadata !"in_counter", metadata !"in_counter", metadata !"", metadata !877, i32 39, metadata !2257, i32 1, i32 1, null} ; [ DW_TAG_variable ]
!2631 = metadata !{i32 786484, i32 0, metadata !876, metadata !"out_counter", metadata !"out_counter", metadata !"", metadata !877, i32 40, metadata !2257, i32 1, i32 1, i64* @out_counter} ; [ DW_TAG_variable ]
!2632 = metadata !{i32 786484, i32 0, metadata !876, metadata !"bsc", metadata !"bsc", metadata !"", metadata !877, i32 41, metadata !2257, i32 1, i32 1, i64* @bsc} ; [ DW_TAG_variable ]
!2633 = metadata !{i32 786484, i32 0, metadata !876, metadata !"buftimeout", metadata !"buftimeout", metadata !"", metadata !877, i32 42, metadata !2259, i32 1, i32 1, i32* @buftimeout} ; [ DW_TAG_variable ]
!2634 = metadata !{i32 786484, i32 0, metadata !876, metadata !"inbuffer_pointer", metadata !"inbuffer_pointer", metadata !"", metadata !877, i32 43, metadata !56, i32 1, i32 1, i32* @inbuffer_pointer} ; [ DW_TAG_variable ]
!2635 = metadata !{i32 786484, i32 0, metadata !876, metadata !"inbuffer", metadata !"inbuffer", metadata !"", metadata !877, i32 44, metadata !2636, i32 1, i32 1, [4096 x %struct.ap_uint.3]* @inbuffer} ; [ DW_TAG_variable ]
...
!2639 = metadata !{i32 786484, i32 0, metadata !876, metadata !"buf_p", metadata !"buf_p", metadata !"", metadata !877, i32 46, metadata !56, i32 1, i32 1, i32* @buf_p} ; [ DW_TAG_variable ]
!2640 = metadata !{i32 786484, i32 0, metadata !876, metadata !"bufsel", metadata !"bufsel", metadata !"", metadata !877, i32 47, metadata !56, i32 1, i32 1, i32* @bufsel} ; [ DW_TAG_variable ]
!2641 = metadata !{i32 786484, i32 0, metadata !876, metadata !"swap_timeout", metadata !"swap_timeout", metadata !"", metadata !877, i32 48, metadata !213, i32 1, i32 1, i1* @swap_timeout} ; [ DW_TAG_variable ]
!2642 = metadata !{i32 786484, i32 0, metadata !876, metadata !"obuffer_ack", metadata !"obuffer_ack", metadata !"", metadata !877, i32 52, metadata !56, i32 1, i32 1, i32* @obuffer_ack} ; [ DW_TAG_variable ]
!2643 = metadata !{i32 786484, i32 0, metadata !876, metadata !"tmpvar", metadata !"tmpvar", metadata !"", metadata !877, i32 54, metadata !2644, i32 1, i32 1, null} ; [ DW_TAG_variable ]
...
!4377 = metadata !{void (%struct.ap_uint.3*, %"class.hls::stream.7"*, i32*, i32, i64*, i32*, i32*, i32*, i32*, i32*, %struct.ap_uint.0.6*, i1, %struct.ap_uint.3*, i64*, i1*)* @data_mover, metadata !4378, metadata !4379, metadata !4380, metadata !4381, metadata !4382, metadata !4383}
...
!4384 = metadata !{null, metadata !4385, metadata !4386, metadata !4387, metadata !4388, metadata !4389, metadata !4383}
...
!4390 = metadata !{null, metadata !4391, metadata !4392, metadata !4393, metadata !4394, metadata !4395, metadata !4383}
...
!4396 = metadata !{null, metadata !4397, metadata !4386, metadata !4398, metadata !4399, metadata !4400, metadata !4383}
...
!4401 = metadata !{null, metadata !4402, metadata !4403, metadata !4404, metadata !4405, metadata !4406, metadata !4383}
...
!4407 = metadata !{null, metadata !4397, metadata !4386, metadata !4408, metadata !4399, metadata !4409, metadata !4383}
!4408 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int_base<32, false> &", metadata !"const ap_int_base<32, true> &"}
!4409 = metadata !{metadata !"kernel_arg_name", metadata !"op", metadata !"op2"}
!4410 = metadata !{null, metadata !4402, metadata !4403, metadata !4411, metadata !4405, metadata !4412, metadata !4383}
!4411 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_uint<64> &"}
!4412 = metadata !{metadata !"kernel_arg_name", metadata !"op2"}
!4413 = metadata !{null, metadata !4402, metadata !4403, metadata !4414, metadata !4405, metadata !4415, metadata !4383}
!4414 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_range_ref<64, false> &"}
!4415 = metadata !{metadata !"kernel_arg_name", metadata !"ref"}
!4416 = metadata !{null, metadata !4402, metadata !4403, metadata !4417, metadata !4405, metadata !4412, metadata !4383}
!4417 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_uint<32> &"}
!4418 = metadata !{null, metadata !4397, metadata !4386, metadata !4419, metadata !4399, metadata !4420, metadata !4383}
!4419 = metadata !{metadata !"kernel_arg_type", metadata !"int", metadata !"int"}
!4420 = metadata !{metadata !"kernel_arg_name", metadata !"Hi", metadata !"Lo"}
!4421 = metadata !{null, metadata !4422, metadata !4423, metadata !4424, metadata !4425, metadata !4426, metadata !4383}
!4422 = metadata !{metadata !"kernel_arg_addr_space", i32 1, i32 0, i32 0}
!4423 = metadata !{metadata !"kernel_arg_access_qual", metadata !"none", metadata !"none", metadata !"none"}
!4424 = metadata !{metadata !"kernel_arg_type", metadata !"ap_int_base<64, false>*", metadata !"int", metadata !"int"}
!4425 = metadata !{metadata !"kernel_arg_type_qual", metadata !"", metadata !"", metadata !""}
!4426 = metadata !{metadata !"kernel_arg_name", metadata !"bv", metadata !"h", metadata !"l"}
!4427 = metadata !{null, metadata !4402, metadata !4403, metadata !4428, metadata !4405, metadata !4429, metadata !4383}
!4428 = metadata !{metadata !"kernel_arg_type", metadata !"struct ap_uint<64> &"}
!4429 = metadata !{metadata !"kernel_arg_name", metadata !"dout"}
!4430 = metadata !{i32 786689, metadata !876, metadata !"a", metadata !877, i32 16777234, metadata !880, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4431 = metadata !{i32 18, i32 37, metadata !876, null}
!4432 = metadata !{i32 786689, metadata !876, metadata !"stream0", metadata !877, i32 33554451, metadata !2228, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4433 = metadata !{i32 19, i32 23, metadata !876, null}
!4434 = metadata !{i32 786689, metadata !876, metadata !"buffer_status", metadata !877, i32 50331668, metadata !150, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4435 = metadata !{i32 20, i32 11, metadata !876, null}
!4436 = metadata !{i32 786689, metadata !876, metadata !"buffer_ack", metadata !877, i32 67108885, metadata !56, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4437 = metadata !{i32 21, i32 10, metadata !876, null}
!4438 = metadata !{i32 786689, metadata !876, metadata !"buffer_seq", metadata !877, i32 83886102, metadata !2256, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4439 = metadata !{i32 22, i32 15, metadata !876, null}
!4440 = metadata !{i32 786689, metadata !876, metadata !"bufsize", metadata !877, i32 100663319, metadata !2258, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4441 = metadata !{i32 23, i32 15, metadata !876, null}
!4442 = metadata !{i32 786689, metadata !876, metadata !"debug_buffer_status", metadata !877, i32 117440536, metadata !150, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4443 = metadata !{i32 24, i32 11, metadata !876, null}
!4444 = metadata !{i32 786689, metadata !876, metadata !"debug_bufsel_0", metadata !877, i32 134217753, metadata !150, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4445 = metadata !{i32 25, i32 11, metadata !876, null}
!4446 = metadata !{i32 786689, metadata !876, metadata !"debug_buf0_p", metadata !877, i32 150994970, metadata !150, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4447 = metadata !{i32 26, i32 11, metadata !876, null}
!4448 = metadata !{i32 786689, metadata !876, metadata !"debug_inbuffer_pointer", metadata !877, i32 167772187, metadata !150, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4449 = metadata !{i32 27, i32 11, metadata !876, null}
!4450 = metadata !{i32 786689, metadata !876, metadata !"debug_dst_var", metadata !877, i32 184549404, metadata !2260, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4451 = metadata !{i32 28, i32 16, metadata !876, null}
!4452 = metadata !{i32 786689, metadata !876, metadata !"run", metadata !877, i32 201326621, metadata !213, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4453 = metadata !{i32 29, i32 11, metadata !876, null}
!4454 = metadata !{i32 786689, metadata !876, metadata !"DDROFFSET", metadata !877, i32 218103838, metadata !883, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4455 = metadata !{i32 30, i32 18, metadata !876, null}
!4456 = metadata !{i32 786689, metadata !876, metadata !"stat_counter", metadata !877, i32 234881055, metadata !2256, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4457 = metadata !{i32 31, i32 15, metadata !876, null}
!4458 = metadata !{i32 786689, metadata !876, metadata !"interrupt_r", metadata !877, i32 251658272, metadata !2262, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4459 = metadata !{i32 32, i32 12, metadata !876, null}
!4460 = metadata !{i32 35, i32 2, metadata !4461, null}
!4461 = metadata !{i32 786443, metadata !876, i32 35, i32 1, metadata !877, i32 0} ; [ DW_TAG_lexical_block ]
!4462 = metadata !{i32 35, i32 39, metadata !4461, null}
!4463 = metadata !{i32 35, i32 73, metadata !4461, null}
!4464 = metadata !{i32 36, i32 1, metadata !4461, null}
!4465 = metadata !{i32 44, i32 34, metadata !4461, null}
!4466 = metadata !{i32 57, i32 2, metadata !4461, null}
!4467 = metadata !{i32 60, i32 2, metadata !4468, null}
!4468 = metadata !{i32 786443, metadata !4461, i32 58, i32 2, metadata !877, i32 1} ; [ DW_TAG_lexical_block ]
!4469 = metadata !{i32 786689, metadata !2551, metadata !"this", metadata !2135, i32 16777328, metadata !4470, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!4470 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !2224} ; [ DW_TAG_pointer_type ]
!4471 = metadata !{i32 112, i32 48, metadata !2551, metadata !4472}
!4472 = metadata !{i32 63, i32 8, metadata !4473, null}
!4473 = metadata !{i32 786443, metadata !4468, i32 61, i32 2, metadata !877, i32 2} ; [ DW_TAG_lexical_block ]
!4474 = metadata !{i32 113, i32 20, metadata !4475, metadata !4472}
!4475 = metadata !{i32 786443, metadata !2551, i32 112, i32 62, metadata !2135, i32 38} ; [ DW_TAG_lexical_block ]
!4476 = metadata !{i32 786688, metadata !4475, metadata !"tmp", metadata !2135, i32 113, metadata !213, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4477 = metadata !{i32 786689, metadata !2550, metadata !"this", metadata !2135, i32 16777339, metadata !4478, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!4478 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !2133} ; [ DW_TAG_pointer_type ]
!4479 = metadata !{i32 123, i32 48, metadata !2550, metadata !4480}
!4480 = metadata !{i32 65, i32 4, metadata !4481, null}
!4481 = metadata !{i32 786443, metadata !4473, i32 63, i32 25, metadata !877, i32 3} ; [ DW_TAG_lexical_block ]
!4482 = metadata !{i32 786688, metadata !4483, metadata !"tmp", metadata !2135, i32 124, metadata !2138, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4483 = metadata !{i32 786443, metadata !2550, i32 123, i32 73, metadata !2135, i32 37} ; [ DW_TAG_lexical_block ]
!4484 = metadata !{i32 124, i32 22, metadata !4483, metadata !4480}
!4485 = metadata !{i32 786689, metadata !2552, metadata !"this", metadata !884, i32 16777402, metadata !4486, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!4486 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !2138} ; [ DW_TAG_pointer_type ]
!4487 = metadata !{i32 186, i32 41, metadata !2552, metadata !4488}
!4488 = metadata !{i32 124, i32 25, metadata !4483, metadata !4480}
!4489 = metadata !{i32 786689, metadata !2553, metadata !"this", metadata !884, i32 16777402, metadata !4486, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!4490 = metadata !{i32 186, i32 41, metadata !2553, metadata !4491}
!4491 = metadata !{i32 186, i32 60, metadata !2552, metadata !4488}
!4492 = metadata !{i32 125, i32 9, metadata !4483, metadata !4480}
!4493 = metadata !{i32 786689, metadata !2535, metadata !"op2", metadata !884, i32 33554712, metadata !2198, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4494 = metadata !{i32 280, i32 84, metadata !2535, metadata !4495}
!4495 = metadata !{i32 126, i32 9, metadata !4483, metadata !4480}
!4496 = metadata !{i32 281, i32 5, metadata !4497, metadata !4495}
!4497 = metadata !{i32 786443, metadata !2535, i32 280, i32 89, metadata !884, i32 26} ; [ DW_TAG_lexical_block ]
!4498 = metadata !{i32 790529, metadata !4499, metadata !"dst_var.V", null, i32 53, metadata !4500, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4499 = metadata !{i32 786688, metadata !4461, metadata !"dst_var", metadata !877, i32 53, metadata !2261, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4500 = metadata !{i32 786438, null, metadata !"ap_uint<64>", metadata !884, i32 183, i64 64, i64 64, i32 0, i32 0, null, metadata !4501, i32 0, null, metadata !2212} ; [ DW_TAG_class_field_type ]
!4501 = metadata !{metadata !4502}
!4502 = metadata !{i32 786438, null, metadata !"ap_int_base<64, false, true>", metadata !866, i32 1453, i64 64, i64 64, i32 0, i32 0, null, metadata !4503, i32 0, null, metadata !2007} ; [ DW_TAG_class_field_type ]
!4503 = metadata !{metadata !4504}
!4504 = metadata !{i32 786438, null, metadata !"ssdm_int<64 + 1024 * 0, false>", metadata !891, i32 68, i64 64, i64 64, i32 0, i32 0, null, metadata !4505, i32 0, null, metadata !1528} ; [ DW_TAG_class_field_type ]
!4505 = metadata !{metadata !1522}
!4506 = metadata !{i32 66, i32 4, metadata !4481, null}
!4507 = metadata !{i32 786688, metadata !4508, metadata !"__Val2__", metadata !866, i32 941, metadata !1523, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4508 = metadata !{i32 786443, metadata !4509, i32 941, i32 14, metadata !866, i32 30} ; [ DW_TAG_lexical_block ]
!4509 = metadata !{i32 786443, metadata !2541, i32 939, i32 85, metadata !866, i32 29} ; [ DW_TAG_lexical_block ]
!4510 = metadata !{i32 941, i32 79, metadata !4508, metadata !4511}
!4511 = metadata !{i32 1538, i32 15, metadata !4512, metadata !4513}
!4512 = metadata !{i32 786443, metadata !2538, i32 1537, i32 93, metadata !866, i32 28} ; [ DW_TAG_lexical_block ]
!4513 = metadata !{i32 200, i32 100, metadata !2537, metadata !4514}
!4514 = metadata !{i32 200, i32 101, metadata !2536, metadata !4515}
!4515 = metadata !{i32 66, i32 35, metadata !4481, null}
!4516 = metadata !{i32 941, i32 81, metadata !4508, metadata !4511}
!4517 = metadata !{i32 786688, metadata !4508, metadata !"__Result__", metadata !866, i32 941, metadata !1523, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4518 = metadata !{i32 790529, metadata !4519, metadata !"ret.V", null, i32 940, metadata !4502, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4519 = metadata !{i32 786688, metadata !4509, metadata !"ret", metadata !866, i32 940, metadata !1516, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4520 = metadata !{i32 941, i32 180, metadata !4508, metadata !4511}
!4521 = metadata !{i32 281, i32 5, metadata !4522, metadata !4515}
!4522 = metadata !{i32 786443, metadata !2546, i32 280, i32 89, metadata !884, i32 34} ; [ DW_TAG_lexical_block ]
!4523 = metadata !{i32 67, i32 4, metadata !4481, null}
!4524 = metadata !{i32 941, i32 79, metadata !4508, metadata !4525}
!4525 = metadata !{i32 1538, i32 15, metadata !4512, metadata !4526}
!4526 = metadata !{i32 200, i32 100, metadata !2537, metadata !4527}
!4527 = metadata !{i32 200, i32 101, metadata !2536, metadata !4528}
!4528 = metadata !{i32 67, i32 35, metadata !4481, null}
!4529 = metadata !{i32 941, i32 81, metadata !4508, metadata !4525}
!4530 = metadata !{i32 941, i32 180, metadata !4508, metadata !4525}
!4531 = metadata !{i32 281, i32 5, metadata !4522, metadata !4528}
!4532 = metadata !{i32 72, i32 5, metadata !4481, null}
!4533 = metadata !{i32 75, i32 5, metadata !4481, null}
!4534 = metadata !{i32 80, i32 5, metadata !4481, null}
!4535 = metadata !{i32 786689, metadata !2535, metadata !"this", metadata !884, i32 16777496, metadata !4486, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!4536 = metadata !{i32 280, i32 50, metadata !2535, metadata !4537}
!4537 = metadata !{i32 84, i32 3, metadata !4481, null}
!4538 = metadata !{i32 281, i32 5, metadata !4497, metadata !4537}
!4539 = metadata !{i32 97, i32 2, metadata !4468, null}
!4540 = metadata !{i32 93, i32 5, metadata !4541, null}
!4541 = metadata !{i32 786443, metadata !4468, i32 92, i32 4, metadata !877, i32 6} ; [ DW_TAG_lexical_block ]
!4542 = metadata !{i32 3426, i32 0, metadata !4543, metadata !4544}
!4543 = metadata !{i32 786443, metadata !2528, i32 3426, i32 255, metadata !866, i32 23} ; [ DW_TAG_lexical_block ]
!4544 = metadata !{i32 3523, i32 0, metadata !4545, metadata !4546}
!4545 = metadata !{i32 786443, metadata !2270, i32 3523, i32 1865, metadata !866, i32 20} ; [ DW_TAG_lexical_block ]
!4546 = metadata !{i32 100, i32 9, metadata !4547, null}
!4547 = metadata !{i32 786443, metadata !4468, i32 98, i32 2, metadata !877, i32 7} ; [ DW_TAG_lexical_block ]
!4548 = metadata !{i32 786689, metadata !2263, metadata !"i_op", metadata !866, i32 16780674, metadata !2266, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4549 = metadata !{i32 3458, i32 122, metadata !2263, metadata !4546}
!4550 = metadata !{i32 1710, i32 68, metadata !4551, metadata !4552}
!4551 = metadata !{i32 786443, metadata !2269, i32 1710, i32 66, metadata !866, i32 19} ; [ DW_TAG_lexical_block ]
!4552 = metadata !{i32 3458, i32 215, metadata !4553, metadata !4546}
!4553 = metadata !{i32 786443, metadata !2263, i32 3458, i32 164, metadata !866, i32 18} ; [ DW_TAG_lexical_block ]
!4554 = metadata !{i32 786688, metadata !4553, metadata !"op2", metadata !866, i32 3458, metadata !1245, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4555 = metadata !{i32 108, i32 3, metadata !4547, null}
!4556 = metadata !{i32 109, i32 3, metadata !4547, null}
!4557 = metadata !{i32 112, i32 4, metadata !4547, null}
!4558 = metadata !{i32 114, i32 5, metadata !4559, null}
!4559 = metadata !{i32 786443, metadata !4547, i32 113, i32 4, metadata !877, i32 8} ; [ DW_TAG_lexical_block ]
!4560 = metadata !{i32 115, i32 5, metadata !4559, null}
!4561 = metadata !{i32 116, i32 5, metadata !4559, null}
!4562 = metadata !{i32 117, i32 5, metadata !4559, null}
!4563 = metadata !{i32 118, i32 5, metadata !4559, null}
!4564 = metadata !{i32 119, i32 5, metadata !4559, null}
!4565 = metadata !{i32 120, i32 6, metadata !4559, null}
!4566 = metadata !{i32 121, i32 10, metadata !4559, null}
!4567 = metadata !{i32 122, i32 6, metadata !4559, null}
!4568 = metadata !{i32 124, i32 5, metadata !4559, null}
!4569 = metadata !{i32 125, i32 5, metadata !4559, null}
!4570 = metadata !{i32 126, i32 18, metadata !4571, null}
!4571 = metadata !{i32 786443, metadata !4559, i32 126, i32 13, metadata !877, i32 9} ; [ DW_TAG_lexical_block ]
!4572 = metadata !{i32 127, i32 6, metadata !4573, null}
!4573 = metadata !{i32 786443, metadata !4571, i32 127, i32 5, metadata !877, i32 10} ; [ DW_TAG_lexical_block ]
!4574 = metadata !{i32 128, i32 1, metadata !4573, null}
!4575 = metadata !{i32 128, i32 6, metadata !4573, null}
!4576 = metadata !{i32 129, i32 5, metadata !4573, null}
!4577 = metadata !{i32 126, i32 26, metadata !4571, null}
!4578 = metadata !{i32 786688, metadata !4461, metadata !"i", metadata !877, i32 51, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4579 = metadata !{i32 131, i32 5, metadata !4559, null}
!4580 = metadata !{i32 132, i32 4, metadata !4559, null}
!4581 = metadata !{i32 133, i32 2, metadata !4547, null}
!4582 = metadata !{i32 136, i32 2, metadata !4468, null}
!4583 = metadata !{i32 140, i32 23, metadata !4584, null}
!4584 = metadata !{i32 786443, metadata !4468, i32 140, i32 18, metadata !877, i32 11} ; [ DW_TAG_lexical_block ]
!4585 = metadata !{i32 141, i32 3, metadata !4586, null}
!4586 = metadata !{i32 786443, metadata !4584, i32 141, i32 2, metadata !877, i32 12} ; [ DW_TAG_lexical_block ]
!4587 = metadata !{i32 142, i32 1, metadata !4586, null}
!4588 = metadata !{i32 142, i32 3, metadata !4586, null}
!4589 = metadata !{i32 144, i32 4, metadata !4590, null}
!4590 = metadata !{i32 786443, metadata !4586, i32 143, i32 3, metadata !877, i32 13} ; [ DW_TAG_lexical_block ]
!4591 = metadata !{i32 145, i32 3, metadata !4590, null}
!4592 = metadata !{i32 147, i32 2, metadata !4586, null}
!4593 = metadata !{i32 140, i32 31, metadata !4584, null}
!4594 = metadata !{i32 148, i32 2, metadata !4468, null}
!4595 = metadata !{i32 150, i32 2, metadata !4468, null}
!4596 = metadata !{i32 151, i32 2, metadata !4468, null}
!4597 = metadata !{i32 153, i32 2, metadata !4468, null}
!4598 = metadata !{i32 158, i32 2, metadata !4468, null}
!4599 = metadata !{i32 159, i32 2, metadata !4468, null}
!4600 = metadata !{i32 160, i32 2, metadata !4468, null}
!4601 = metadata !{i32 161, i32 2, metadata !4468, null}
!4602 = metadata !{i32 168, i32 2, metadata !4468, null}
!4603 = metadata !{i32 170, i32 3, metadata !4604, null}
!4604 = metadata !{i32 786443, metadata !4468, i32 169, i32 2, metadata !877, i32 14} ; [ DW_TAG_lexical_block ]
!4605 = metadata !{i32 172, i32 2, metadata !4604, null}
!4606 = metadata !{i32 174, i32 3, metadata !4468, null}
!4607 = metadata !{i32 171, i32 3, metadata !4604, null}
!4608 = metadata !{i32 179, i32 2, metadata !4468, null}
!4609 = metadata !{i32 182, i32 3, metadata !4610, null}
!4610 = metadata !{i32 786443, metadata !4461, i32 181, i32 2, metadata !877, i32 15} ; [ DW_TAG_lexical_block ]
!4611 = metadata !{i32 183, i32 3, metadata !4610, null}
!4612 = metadata !{i32 184, i32 3, metadata !4610, null}
!4613 = metadata !{i32 185, i32 3, metadata !4610, null}
!4614 = metadata !{i32 186, i32 3, metadata !4610, null}
!4615 = metadata !{i32 187, i32 3, metadata !4610, null}
!4616 = metadata !{i32 189, i32 3, metadata !4610, null}
!4617 = metadata !{i32 190, i32 3, metadata !4610, null}
!4618 = metadata !{i32 191, i32 17, metadata !4619, null}
!4619 = metadata !{i32 786443, metadata !4610, i32 191, i32 12, metadata !877, i32 16} ; [ DW_TAG_lexical_block ]
!4620 = metadata !{i32 192, i32 4, metadata !4621, null}
!4621 = metadata !{i32 786443, metadata !4619, i32 192, i32 3, metadata !877, i32 17} ; [ DW_TAG_lexical_block ]
!4622 = metadata !{i32 193, i32 1, metadata !4621, null}
!4623 = metadata !{i32 193, i32 3, metadata !4621, null}
!4624 = metadata !{i32 194, i32 3, metadata !4621, null}
!4625 = metadata !{i32 195, i32 3, metadata !4621, null}
!4626 = metadata !{i32 196, i32 2, metadata !4621, null}
!4627 = metadata !{i32 191, i32 25, metadata !4619, null}
!4628 = metadata !{i32 198, i32 3, metadata !4610, null}
!4629 = metadata !{i32 200, i32 1, metadata !4461, null}
