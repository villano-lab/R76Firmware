...
set Interfaces {
    s_axi_axil {
        ...
        registers {{0x10 buffer_status R 0x0 "Data signal of buffer_status" {{0 32 buffer_status R 0 "Bit 31 to 0 Data signal of buffer_status"}}} {0x14 buffer_status_ctrl R 0x0 "Control signal of buffer_status" {{0 1 buffer_status_ap_vld R 0 "Control signal buffer_status_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 buffer_ack W 0x0 "Data signal of buffer_ack" {{0 32 buffer_ack W 0 "Bit 31 to 0 Data signal of buffer_ack"}}} {0x38 run W 0x0 "Data signal of run" {{0 1 run W 0 "Bit 0 to 0 Data signal of run"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 DDROFFSET_V W 0x0 "Data signal of DDROFFSET_V" {{0 32 DDROFFSET_V W 0 "Bit 31 to 0 Data signal of DDROFFSET_V"}}}}
...
## System Info
set user_parameters_list {clk_period 8 machine 64 combinational 0 latency 2 II x}
