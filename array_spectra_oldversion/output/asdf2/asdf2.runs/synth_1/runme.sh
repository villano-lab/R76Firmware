...
HD_PWD='C:/Users/hellmala/Documents/GitHub/R76Firmware/array_spectra_oldversion/output/asdf2/asdf2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_asdf2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_asdf2.tcl
