...
HD_PWD='C:/Users/Owner/Documents/GitHub/R76Firmware/array_spectra_oldversion/output/asdf1/asdf1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_asdf1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_asdf1.tcl
