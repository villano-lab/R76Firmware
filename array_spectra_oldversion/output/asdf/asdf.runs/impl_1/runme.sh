...
HD_PWD='C:/Users/Owner/Documents/GitHub/R76Firmware/array_spectra_oldversion/output/asdf/asdf.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_asdf.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_asdf.tcl -notrace
